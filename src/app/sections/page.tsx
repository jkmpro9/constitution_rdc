...
export default function SectionsPage() {
  ...
  return (
    <>
      <SEOHead
        title="Constitution de la RDC — Sommaire"
        description="Consultez la Constitution de la République Démocratique du Congo. Navigation par titres, chapitres et articles. 229 articles répartis en 8 titres."
      />
